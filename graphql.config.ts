...
const config: IGraphQLConfig = {
  ...
  extensions: {
    ...
    codegen: {
      ...
      // generates typescript type from GraphQL schema
      generates: {
        ...
        // this defines how the generated types will look like
          config: {
            skipTypename: true, // skipTypename is used to remove _typename from the generated types
        ...
        "src/graphql/types.ts": {
            ...
            // import-types suggests to import types from schema.types.ts or other file
        ...
        //   plugins is used to define plugins that will be used to generate typescript types from GraphQL operations
          plugins: ["typescript-operations"],
          config: {
            skipTypename: true,
            enumsAsTypes: true,
            // determine wether the generated type should be resolved ahead of time or not
            // when preResolveTypes is set to false, the code generator will not try to resolve the types ahead of time.
            // instead, it will generate more specific types, and the actual types will be resolved at runtime 
